...
public class TestProfileSlabTE_2D implements Experiment {
	...
	public void run(AbstractResultsManager man, AbstractResultsDisplayer dis)
		...
		double[] zValNm = new double[Nz] ;
		for(int i=0; i<Nz; i++){
			zValNm[i] = zMin + i*Dz ;
			dp.addResultProperty("Z position (nm)", zValNm[i]);
			man.addDataPoint(dp);
		}
