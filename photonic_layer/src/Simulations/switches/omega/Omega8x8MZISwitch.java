package Simulations.switches.omega;
...
public class Omega8x8MZISwitch implements Experiment {
...
//		dp.addProperty("State of all Switches", stateSwitches);
		dp.addProperty("State of Sources", stateOfSources);
...
/*		dp.addResultProperty("Port 1 Out Stage 0", checkNaN(10*Math.log10(ports0[0].absSquared())));
		dp.addResultProperty("Port 2 Out Stage 0", checkNaN(10*Math.log10(ports0[1].absSquared())));
		dp.addResultProperty("Port 3 Out Stage 0", checkNaN(10*Math.log10(ports0[2].absSquared())));
		dp.addResultProperty("Port 4 Out Stage 0", checkNaN(10*Math.log10(ports0[3].absSquared())));
		dp.addResultProperty("Port 5 Out Stage 0", checkNaN(10*Math.log10(ports0[4].absSquared())));
		dp.addResultProperty("Port 6 Out Stage 0", checkNaN(10*Math.log10(ports0[5].absSquared())));
		dp.addResultProperty("Port 7 Out Stage 0", checkNaN(10*Math.log10(ports0[6].absSquared())));
		dp.addResultProperty("Port 8 Out Stage 0", checkNaN(10*Math.log10(ports0[7].absSquared())));*/
		
		// Stage 1
		Complex[] ports1 = getCrossingPorts(ports0) ;
		
/*		dp.addResultProperty("Port 1 Out Stage 1", checkNaN(10*Math.log10(ports1[0].absSquared())));
		dp.addResultProperty("Port 2 Out Stage 1", checkNaN(10*Math.log10(ports1[1].absSquared())));
		dp.addResultProperty("Port 3 Out Stage 1", checkNaN(10*Math.log10(ports1[2].absSquared())));
		dp.addResultProperty("Port 4 Out Stage 1", checkNaN(10*Math.log10(ports1[3].absSquared())));
		dp.addResultProperty("Port 5 Out Stage 1", checkNaN(10*Math.log10(ports1[4].absSquared())));
		dp.addResultProperty("Port 6 Out Stage 1", checkNaN(10*Math.log10(ports1[5].absSquared())));
		dp.addResultProperty("Port 7 Out Stage 1", checkNaN(10*Math.log10(ports1[6].absSquared())));
		dp.addResultProperty("Port 8 Out Stage 1", checkNaN(10*Math.log10(ports1[7].absSquared())));*/
		
		// Stage 2
		Complex[] ports2 = getColumnSwitchPorts(ports1, 1) ;
		
/*		dp.addResultProperty("Port 1 Out Stage 2", checkNaN(10*Math.log10(ports2[0].absSquared())));
		dp.addResultProperty("Port 2 Out Stage 2", checkNaN(10*Math.log10(ports2[1].absSquared())));
		dp.addResultProperty("Port 3 Out Stage 2", checkNaN(10*Math.log10(ports2[2].absSquared())));
		dp.addResultProperty("Port 4 Out Stage 2", checkNaN(10*Math.log10(ports2[3].absSquared())));
		dp.addResultProperty("Port 5 Out Stage 2", checkNaN(10*Math.log10(ports2[4].absSquared())));
		dp.addResultProperty("Port 6 Out Stage 2", checkNaN(10*Math.log10(ports2[5].absSquared())));
		dp.addResultProperty("Port 7 Out Stage 2", checkNaN(10*Math.log10(ports2[6].absSquared())));
		dp.addResultProperty("Port 8 Out Stage 2", checkNaN(10*Math.log10(ports2[7].absSquared())));*/
		
		// Stage 3
		Complex[] ports3 = getCrossingPorts(ports2) ;
		
/*		dp.addResultProperty("Port 1 Out Stage 3", checkNaN(10*Math.log10(ports3[0].absSquared())));
		dp.addResultProperty("Port 2 Out Stage 3", checkNaN(10*Math.log10(ports3[1].absSquared())));
		dp.addResultProperty("Port 3 Out Stage 3", checkNaN(10*Math.log10(ports3[2].absSquared())));
		dp.addResultProperty("Port 4 Out Stage 3", checkNaN(10*Math.log10(ports3[3].absSquared())));
		dp.addResultProperty("Port 5 Out Stage 3", checkNaN(10*Math.log10(ports3[4].absSquared())));
		dp.addResultProperty("Port 6 Out Stage 3", checkNaN(10*Math.log10(ports3[5].absSquared())));
		dp.addResultProperty("Port 7 Out Stage 3", checkNaN(10*Math.log10(ports3[6].absSquared())));
		dp.addResultProperty("Port 8 Out Stage 3", checkNaN(10*Math.log10(ports3[7].absSquared())));
		*/
		// Stage 4
		Complex[] ports4 = getColumnSwitchPorts(ports3, 2) ;
		
/*		dp.addResultProperty("Port 1 Out Stage 4", checkNaN(10*Math.log10(ports4[0].absSquared())));
		dp.addResultProperty("Port 2 Out Stage 4", checkNaN(10*Math.log10(ports4[1].absSquared())));
		dp.addResultProperty("Port 3 Out Stage 4", checkNaN(10*Math.log10(ports4[2].absSquared())));
		dp.addResultProperty("Port 4 Out Stage 4", checkNaN(10*Math.log10(ports4[3].absSquared())));
		dp.addResultProperty("Port 5 Out Stage 4", checkNaN(10*Math.log10(ports4[4].absSquared())));
		dp.addResultProperty("Port 6 Out Stage 4", checkNaN(10*Math.log10(ports4[5].absSquared())));
		dp.addResultProperty("Port 7 Out Stage 4", checkNaN(10*Math.log10(ports4[6].absSquared())));
		dp.addResultProperty("Port 8 Out Stage 4", checkNaN(10*Math.log10(ports4[7].absSquared())));*/
		
		// Stage 5
		Complex[] ports5 = getCrossingPorts(ports4) ;
		
/*		dp.addResultProperty("Port 1 Out Stage 5", checkNaN(10*Math.log10(ports5[0].absSquared())));
		dp.addResultProperty("Port 2 Out Stage 5", checkNaN(10*Math.log10(ports5[1].absSquared())));
		dp.addResultProperty("Port 3 Out Stage 5", checkNaN(10*Math.log10(ports5[2].absSquared())));
		dp.addResultProperty("Port 4 Out Stage 5", checkNaN(10*Math.log10(ports5[3].absSquared())));
		dp.addResultProperty("Port 5 Out Stage 5", checkNaN(10*Math.log10(ports5[4].absSquared())));
		dp.addResultProperty("Port 6 Out Stage 5", checkNaN(10*Math.log10(ports5[5].absSquared())));
		dp.addResultProperty("Port 7 Out Stage 5", checkNaN(10*Math.log10(ports5[6].absSquared())));
		dp.addResultProperty("Port 8 Out Stage 5", checkNaN(10*Math.log10(ports5[7].absSquared())));*/
		
		// Stage 6
		Complex[] ports6 = getColumnSwitchPorts(ports5, 3) ;
		
/*		dp.addResultProperty("Port 1 Out", checkNaN(10*Math.log10(ports6[0].absSquared())));
		dp.addResultProperty("Port 2 Out", checkNaN(10*Math.log10(ports6[1].absSquared())));
		dp.addResultProperty("Port 3 Out", checkNaN(10*Math.log10(ports6[2].absSquared())));
		dp.addResultProperty("Port 4 Out", checkNaN(10*Math.log10(ports6[3].absSquared())));
		dp.addResultProperty("Port 5 Out", checkNaN(10*Math.log10(ports6[4].absSquared())));
		dp.addResultProperty("Port 6 Out", checkNaN(10*Math.log10(ports6[5].absSquared())));
		dp.addResultProperty("Port 7 Out", checkNaN(10*Math.log10(ports6[6].absSquared())));
		dp.addResultProperty("Port 8 Out", checkNaN(10*Math.log10(ports6[7].absSquared())));*/

		for(int i=0; i<8; i++){
			checkDataPoint(dp, stateSwitches, ports6[i].absSquared(), i, 6, -30, 1);
		}
	...
	public void checkDataPoint(DataPoint dp, String state, double value, int portIndex, int stageIndex, double minValuedB, double maxValuedB){
		double valuedB = checkNaN(10*Math.log10(value)) ;
		if(valuedB>=minValuedB && valuedB<= maxValuedB){
			dp.addResultProperty("Port "+(portIndex+1)+" Out Stage "+stageIndex, valuedB);
			dp.addProperty("State of All Switches", state);
		}
	}
