...
public class Benes4x4MZISwitch_AllConfig_RMSE implements Experiment {
	...
	Switch2x2MZIDistributedCoupler swR1C1, swR1C2, swR1C3, swR2C1, swR2C2, swR2C3;
	...
	public ComplexMatrix getColumnTransitionMatrix(int columnNum){
		...
		double[] r4 = {0,0,0,1} ;
		int m = columnNum ;
		String sw1 = state[2*m-2];
		String sw2 = state[2*m-1];
...
//		double qBER = 6 ; // for BER = 10^(-9)
	...
	public void run(AbstractResultsManager man, AbstractResultsDisplayer dis)
		...
		line += String.format("%2.4f", ppAvg) + "     " ;
//		line += String.format("%2.4f", ppAvg+err) + "     " ;
	...
	public static void main(String[] args){
		...
		String classString = "Simulations.switches.thesis.benes4x4.Benes4x4MZISwitch_AllConfig_RMSE" ;
