...
public class AddDropThirdOrderSim implements Experiment {

	AddDropThirdOrder adr;
	StripWg stripWg;
	double radius_um, loss_dBperCm, neff, lambda_nm;
	double kin, kout, k12, k23;
	boolean print;
	public static boolean filePrint = true;
	public static String path = System.getProperty("user.home") + File.separator + "Desktop";

	public AddDropThirdOrderSim(@ParamName(name = "Strip Wg") StripWg stripWg,
	...
	public void run(AbstractResultsManager man, AbstractResultsDisplayer dis) throws WrongExperimentException {
		...
		adr = new AddDropThirdOrder(phi_rad, loss, kin, kout, k12, k23);
		...
		if (filePrint && print) {
			FileOutput fout = new FileOutput(path + File.separator + "adr_third_order_drop_thru.txt");
