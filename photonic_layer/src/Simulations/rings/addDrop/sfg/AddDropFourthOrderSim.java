...
public class AddDropFourthOrderSim implements Experiment {

	AddDropFourthOrder adr;
	StripWg stripWg;
	double radius_um, loss_dBperCm, neff, lambda_nm;
	double kin, kout, k12, k23, k34;
	boolean print;
	public static boolean filePrint = true;
	public static String path = System.getProperty("user.home") + File.separator + "Desktop";

	public AddDropFourthOrderSim(@ParamName(name = "Strip Wg") StripWg stripWg,
			...
			@ParamName(name = "kappa_34") double k34, @ParamName(name = "output kappa") double kout,
	...
	public void run(AbstractResultsManager man, AbstractResultsDisplayer dis) throws WrongExperimentException {
		...
		adr = new AddDropFourthOrder(phi_rad, loss, kin, kout, k12, k23, k34);
		...
		if (filePrint && print) {
			FileOutput fout = new FileOutput(path + File.separator + "adr_fourth_order_drop_thru.txt");
