...
public class AddDropSecondOrderSim implements Experiment {
	...
	public AddDropSecondOrderSim(@ParamName(name = "Strip Wg") StripWg stripWg,
			...
			@ParamName(name = "kappa_12") double k12, @ParamName(name = "output kappa") double kout,
	...
	public void run(AbstractResultsManager man, AbstractResultsDisplayer dis) throws WrongExperimentException {
		...
		adr = new AddDropSecondOrder(phi_rad, loss, kin, kout, k12);
		...
		if (filePrint && print) {
			FileOutput fout = new FileOutput(path + File.separator + "adr_second_order_drop_thru.txt");
