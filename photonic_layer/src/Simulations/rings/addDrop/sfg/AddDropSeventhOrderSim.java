...
import PhotonicElements.RingStructures.AddDrop.Graph.AddDropSeventhOrder;
...
public class AddDropSeventhOrderSim implements Experiment {

	AddDropSeventhOrder adr;
	StripWg stripWg;
	double radius_um, loss_dBperCm, neff, lambda_nm;
	double kin, kout, k12, k23, k34, k45, k56, k67;
	boolean print;
	public static boolean filePrint = true;
	public static String path = System.getProperty("user.home") + File.separator + "Desktop";

	public AddDropSeventhOrderSim(@ParamName(name = "Strip Wg") StripWg stripWg,
			...
			@ParamName(name = "kappa_56") double k56, @ParamName(name = "kappa_67") double k67,
	...
	public void run(AbstractResultsManager man, AbstractResultsDisplayer dis) throws WrongExperimentException {
		...
		adr = new AddDropSeventhOrder(phi_rad, loss, kin, kout, k12, k23, k34, k45, k56, k67);
		...
		if (filePrint && print) {
			FileOutput fout = new FileOutput(path + File.separator + "adr_seventh_order_drop_thru.txt");
