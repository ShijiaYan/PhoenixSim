...
import GDS.Elements.Shapes.PathElements.AbstractPathElement;
import GDS.Elements.Shapes.PathElements.Arc;
import GDS.Elements.Shapes.PathElements.Segment;
...
//			if(temp[i]=='W') {map[k] = "W" ; k++ ; wgCounter++ ;}
	...
	public static void main(String[] args){
		...
		Port port = new Port(zero, 0.4, 180) ;
		PortConnector pc = new PortConnector("as", new AbstractLayerMap[] {new SEAM()}, port, port, "ll") ;
		System.out.println(pc.map[0]);
		System.out.println(pc.pathElements.length);
		System.out.println(pc.pathConnector.port1.getNormalDegree()) ;
		System.out.println(pc.pathConnector.port2.getNormalDegree()) ;
	}
