package People.Meisam.GUI.PhoenixSim.TabsLibrary.Materials;
...
public class MaterialsTab extends AbstractTab {
	...
	FXMLLoader loader = new FXMLLoader(Class.class.getResource("/People/Meisam/GUI/PhoenixSim/TabsLibrary/Materials/materials.fxml")) ;
