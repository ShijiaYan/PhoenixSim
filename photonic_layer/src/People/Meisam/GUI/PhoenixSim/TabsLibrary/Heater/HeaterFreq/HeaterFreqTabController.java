package People.Meisam.GUI.PhoenixSim.TabsLibrary.Heater.HeaterFreq;
...
public class HeaterFreqTabController extends AbstractTabController {
    ...
    Tab freqTab;
    @FXML
    Pane freqMatlabPlotPane;
    @FXML
    TextField f0TextField;
    @FXML
    TextField nuTextField;
    @FXML
    Label f0Label;
    @FXML
    Label nuLabel;
    @FXML
    ToggleGroup freqPlot;
    @FXML
    RadioButton ampdBPlotRadioButton;
    @FXML
    RadioButton ampPlotRadioButton;
    @FXML
    RadioButton phaseRadRadioButton;
    @FXML
    RadioButton phaseDegreeRadioButton;
