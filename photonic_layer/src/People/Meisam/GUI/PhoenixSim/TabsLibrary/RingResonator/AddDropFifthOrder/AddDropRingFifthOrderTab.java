package People.Meisam.GUI.PhoenixSim.TabsLibrary.RingResonator.AddDropFifthOrder;
...
public class AddDropRingFifthOrderTab extends AbstractTab {
	...
	FXMLLoader loader = new FXMLLoader(Class.class.getResource("/People/Meisam/GUI/PhoenixSim/TabsLibrary/RingResonator/AddDropFifthOrder/add_drop_ring_fifth_order.fxml")) ;
