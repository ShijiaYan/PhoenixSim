package People.Meisam.GUI.PhoenixSim.TabsLibrary.Measurements.AddDropFitting.SymmetricDropBackScattering;
	...
	public void calculateKappa() {
		...
		if (fitTodB.isSelected()) {
			...
			for (int i = 0; i < fitted_plot.length; i++) {
				adr = new AddDropBS(new Wavelength(lambda_nm[i]), lambda_res_nm, FSR_nm, kappa, kappa, L,
						new LumpedReflector(r, 0));
