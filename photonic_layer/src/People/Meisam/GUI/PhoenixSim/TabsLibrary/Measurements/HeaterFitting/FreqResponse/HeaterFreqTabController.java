package People.Meisam.GUI.PhoenixSim.TabsLibrary.Measurements.HeaterFitting.FreqResponse;
...
public class HeaterFreqTabController extends AbstractTabController {
	...
	public void calculate() {
		...
		double[] voltage_V_normalized = MoreMath.Arrays.times(voltage_V,
				1 / MoreMath.Arrays.FindMaximum.getValue(voltage_V));
		...
		double[] freq_values_kHz = MoreMath.linspace(MoreMath.Arrays.FindMinimum.getValue(freq_kHz),
				MoreMath.Arrays.FindMaximum.getValue(freq_kHz), 1000);
