package People.Meisam.GUI.PhoenixSim.TabsLibrary.Measurements.BERPenalty;
...
public class BERPenaltyTabController extends AbstractTabController {
	...
	Pane matlabPane;
	@FXML
	TextField xDataCase1TextField;
	@FXML
	Label xDataCase1Label;
	@FXML
	TextField yDataCase1TextField;
	@FXML
	Label yDataCase1Label;
	@FXML
	TextField xDataCase2TextField;
	@FXML
	Label xDataCase2Label;
	@FXML
	TextField yDataCase2TextField;
	@FXML
	Label yDataCase2Label;
	@FXML
	...
	private void calculate() {
		...
		xDataCase1Fitted = new SimulationVariable(xDataCase1.getName() + "-fit", xDataCase1.getAlias() + "-fit",
				prec1_dense_dBm);
		yDataCase1Fitted = new SimulationVariable(yDataCase1.getName() + "-fit", yDataCase1.getAlias() + "-fit",
				logBER1_dense);
		...
		xDataCase2Fitted = new SimulationVariable(xDataCase2.getName() + "-fit", xDataCase2.getAlias() + "-fit",
				prec2_dense_dBm);
		yDataCase2Fitted = new SimulationVariable(yDataCase2.getName() + "-fit", yDataCase2.getAlias() + "-fit",
				logBER2_dense);
