package People.Meisam.GUI.PhoenixSim.TabsLibrary.Measurements.DataSmoothing;
...
public class DataSmoothingTabController extends AbstractTabController {
	...
	Label yDataLabel;
	@FXML
	TextField nLeftTextField;
	@FXML
	Label nLeftLabel;
	@FXML
	TextField nRightTextField;
	@FXML
	Label nRightLabel;
	@FXML
	...
	public void chooseXData() {
		...
		varModule.setExitAction(new ActionInterface() {
			...
			public void setExitAction() {
				xData = new SimulationVariable(varModule.getController().getVariable().getName(),
	...
	public void chooseYData() {
		...
		varModule.setExitAction(new ActionInterface() {
			...
			@Override
			public void setExitAction() {
				yData = new SimulationVariable(varModule.getController().getVariable().getName(),
						varModule.getController().getVariable().getAlias(), varModule.getController().getValues());
				yDataLabel.setText("Y data is set to '" + yData.getName() + "'");
				if (xData != null && yData != null) { fig = createPlot(xData, yData); showPlot(fig, matlabPane); }
			}
