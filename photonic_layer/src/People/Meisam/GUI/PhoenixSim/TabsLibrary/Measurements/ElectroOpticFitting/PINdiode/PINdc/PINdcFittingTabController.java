package People.Meisam.GUI.PhoenixSim.TabsLibrary.Measurements.ElectroOpticFitting.PINdiode.PINdc;
...
public class PINdcFittingTabController extends AbstractTabController {
	...
	public void calculate() {
		...
		double[] V_values = MoreMath.linspace(MoreMath.Arrays.FindMinimum.getValue(voltage_V),
				MoreMath.Arrays.FindMaximum.getValue(voltage_V), 1000);
