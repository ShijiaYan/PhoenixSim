package People.Meisam.GUI.PhoenixSim.TabsLibrary.Measurements.AddDropFitting.SymmetricDropBackScatteringDoubleReflector;
	...
	public void calculateKappa() {
		...
		Function fitFunc = new Function() {
			...
			public double evaluate(double[] values, double[] parameters) {
				...
				adr = new AddDropBackScatteringAsymmetricAbstract(new Wavelength(lambdaNm), lambda_res_nm, FSR_nm,
						kappa, kappa, L, new LumpedReflector(r1, 0), new LumpedReflector(r1, phi));
		...
		for (int i = 0; i < fitted_plot.length; i++) {
			adr = new AddDropBackScatteringAsymmetricAbstract(new Wavelength(lambda_nm[i]), lambda_res_nm, FSR_nm,
					kappa, kappa, 1, new LumpedReflector(r1, 0), new LumpedReflector(r1, phi));
