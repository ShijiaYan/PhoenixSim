...
public class RingWgCouplerSiNTabController extends AbstractTabController {
    ...
    private double getKappaRingWg(double lambda_nm, double radius_um, double d_nm, double width_nm){
    	...
    	RingWgCoupler rwDC = new RingWgCoupler(new Wavelength(lambda_nm), wgProp, width_nm, radius_um, d_nm, 1500, neff_even_interpolator, neff_odd_interpolator) ;
