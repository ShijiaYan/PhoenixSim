package People.Meisam.GUI.PhoenixSim.TabsLibrary.CouplerDesigner.RaceTrack;
...
public class RaceTrackCouplerTab extends AbstractTab {
	...
	FXMLLoader loader = new FXMLLoader(Class.class.getResource("/People/Meisam/GUI/PhoenixSim/TabsLibrary/CouplerDesigner/RaceTrack/race_track_coupler.fxml")) ; ;
