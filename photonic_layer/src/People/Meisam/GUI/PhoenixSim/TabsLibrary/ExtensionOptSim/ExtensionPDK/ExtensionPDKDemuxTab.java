...
public class ExtensionPDKDemuxTab extends AbstractTab {

	FXMLLoader loader = new FXMLLoader(Class.class.getResource(
			"/People/Meisam/GUI/PhoenixSim/TabsLibrary/ExtensionOptSim/ExtensionPDK/ExtensionCustomPDK.fxml"));
	ExtensionPDKDemuxTabController controller;

	public ExtensionPDKDemuxTab(SimulationDataBase simDataBase) {
		try {
			loader.load();
		} catch (IOException e) {
			e.printStackTrace();
	...
	@Override
	public ExtensionPDKDemuxTabController getController() {
		return controller;
	}
