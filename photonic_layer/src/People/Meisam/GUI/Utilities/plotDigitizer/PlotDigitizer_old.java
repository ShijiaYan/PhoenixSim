package People.Meisam.GUI.Utilities.plotDigitizer;
...
public class PlotDigitizer_old extends Canvas implements MouseListener {
	...
	public PlotDigitizer_old(String arg0) {
		this.setWindowSize();
		this.path = arg0;
		this.selectImage();
		this.setImage();
	...
	// this is the constructor that I'm using in the phoenixSim --> with javafx file chooser
	public PlotDigitizer_old(FileChooserFX fc) {
		this.setWindowSize();
		this.selectImage(fc);
		this.setImage();
		this.outputFileChoice();
	...
	public PlotDigitizer_old(FileChooserFX fc, boolean xAxisIsLinear, boolean yAxisIsLinear) {
		this.setWindowSize();
		this.selectImage(fc);
		this.setImage();
		this.outputFileChoice();
	...
	private void cursorDoneSign(Graphics arg0, int arg1, int arg2) {
		...
		arg0.fillOval(arg1 - 3, arg2 - 3, 7, 7);
	}
