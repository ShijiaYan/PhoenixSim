package People.Qixiang.RingSwitch;
...
public class Switch2x2Ring {
	...
	public Switch2x2Ring(
			...
			@ParamName(name="Locked Resonance wavelength (nm)") double resLambdaNm,
			@ParamName(name="Plasma Effect") PlasmaDispersionModel plasmaEffect
			){
		...
		// creating thermal lock heaters
		ResonanceLock resLock = new ResonanceLock(radiusMicron, resLambdaNm) ;
		...
		this.Cwg4 = new CurvedWg(inputLambda, wgProp, radiusMicron, 270, true, plasmaEffect, true, resLock.getLockHeater()) ;
	...
	private Complex[] excitePorts(Complex port1_in, Complex port2_in, Complex port3_in, Complex port4_in){
		...
		for(int i=0; i<steps; i++){
			...
			wg3_port1_out = wg3.getPort1(X_port3_out, DC4_port1_out) ;
			wg3_port2_out = wg3.getPort2(X_port3_out, DC4_port1_out) ;
			
			wg4_port1_out = wg4.getPort1(X_port4_out, DC3_port2_out) ;
			wg4_port2_out = wg4.getPort2(X_port4_out, DC3_port2_out) ;
			
			DC3_port1_out = DC3.getPort1(port4_in, wg4_port2_out, Cwg3_port1_out, Cwg4_port2_out) ; // this is output port 4
			DC3_port2_out = DC3.getPort2(port4_in, wg4_port2_out, Cwg3_port1_out, Cwg4_port2_out) ;
			DC3_port3_out = DC3.getPort3(port4_in, wg4_port2_out, Cwg3_port1_out, Cwg4_port2_out) ;
			DC3_port4_out = DC3.getPort4(port4_in, wg4_port2_out, Cwg3_port1_out, Cwg4_port2_out) ;
			
			DC4_port1_out = DC4.getPort1(wg3_port2_out, port3_in, Cwg4_port1_out, Cwg3_port2_out) ;
			DC4_port2_out = DC4.getPort2(wg3_port2_out, port3_in, Cwg4_port1_out, Cwg3_port2_out) ; // this is output port 3
			DC4_port3_out = DC4.getPort3(wg3_port2_out, port3_in, Cwg4_port1_out, Cwg3_port2_out) ;
			DC4_port4_out = DC4.getPort4(wg3_port2_out, port3_in, Cwg4_port1_out, Cwg3_port2_out) ;
			
			Cwg3_port1_out = Cwg3.getPort1(DC3_port3_out, DC4_port4_out) ;
			Cwg3_port2_out = Cwg3.getPort2(DC3_port3_out, DC4_port4_out) ;
			
			Cwg4_port1_out = Cwg4.getPort1(DC4_port3_out, DC3_port4_out) ;
			Cwg4_port2_out = Cwg4.getPort2(DC4_port3_out, DC3_port4_out) ;
			...
			port3_out = port3_out.plus(DC4_port2_out) ;
			port4_out = port4_out.plus(DC3_port1_out) ;
