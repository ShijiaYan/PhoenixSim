...
public class Switch2x2MZIDemo implements Experiment {
	...
	public void run(AbstractResultsManager man, AbstractResultsDisplayer dis) throws WrongExperimentException {
		...
		dp.addResultProperty("EO phase shift (degree)", mziSwitch.getLowerWg().getS21().phaseDegree() - mziSwitch.getUpperWg().getS21().phaseDegree());
		
		// adding the optical power transmission
		dp.addResultProperty("Cross Power Transmission (dB)", MoreMath.Conversions.todB(mziSwitch.getS31().absSquared()));
