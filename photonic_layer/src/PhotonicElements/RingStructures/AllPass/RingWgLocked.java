...
public class RingWgLocked {
	...
	public RingWgLocked (
		...
		this.Cwg1 = new CurvedWg(inputLambda, wgProp, radiusMicron, 360, false, null, true, resLock.getLockHeater()) ; // full circle curved waveguide = 360 degree
