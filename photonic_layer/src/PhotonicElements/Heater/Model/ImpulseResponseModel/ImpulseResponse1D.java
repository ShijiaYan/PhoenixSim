package PhotonicElements.Heater.Model.ImpulseResponseModel;

import PhotonicElements.Heater.Model.Structure.HeaterWgCrossSection;
...
public class ImpulseResponse1D extends AbstractImpulseResponse {
	...
	public double[] getNormalizedImpulseResponse(double[] t_usec){
		...
		return MoreMath.Arrays.times(response, 1/getPeakValue()) ;
	}
