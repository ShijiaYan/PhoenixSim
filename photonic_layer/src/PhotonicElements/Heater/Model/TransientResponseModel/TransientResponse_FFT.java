...
//			freqImpulseReal[i] = impulse.getTimeResponse(time_usec[i]) ;
		...
		freqTempReal = MoreMath.Arrays.concat(freqTempReal, MoreMath.Arrays.setZero(N)) ;
		freqTempImag = MoreMath.Arrays.concat(freqTempImag, MoreMath.Arrays.setZero(N)) ;

		freqImpulseReal = MoreMath.Arrays.concat(freqImpulseReal, MoreMath.Arrays.setZero(N)) ;
		freqImpulseImag = MoreMath.Arrays.concat(freqImpulseImag, MoreMath.Arrays.setZero(N)) ;
