package PhotonicElements.EffectiveIndexMethod.ModeSensitivity.StripWg;
...
public class NeffVariationStripWgTE {
	...
	public NeffVariationStripWgTE(
		...
		ModeStripWgTE stripTE_original = new ModeStripWgTE(stripWg_original, mIndex, nIndex) ; // for TEmn mode
		ModeStripWgTE stripTE_perturbed = new ModeStripWgTE(stripWg_perturbed, mIndex, nIndex) ; // for TEmn mode
		neff_original = stripTE_original.getEffectiveIndex() ;
		neff_perturbed = stripTE_perturbed.getEffectiveIndex() ;
		Dneff = neff_perturbed - neff_original ;
		ng_original = stripTE_original.getGroupIndex() ;
		ng_perturbed = stripTE_perturbed.getGroupIndex() ;
	...
	public NeffVariationStripWgTE(
		...
		StripWg stripWg_perturbed = new StripWg(inputLambda, widthNm + DwNm, heightNm + DhNm, DnSi, DnSiO2) ;
		ModeStripWgTE stripTE_original = new ModeStripWgTE(stripWg_original, 0, 0) ; // for TE00 mode
		ModeStripWgTE stripTE_perturbed = new ModeStripWgTE(stripWg_perturbed, 0, 0) ; // for TE00 mode
		neff_original = stripTE_original.getEffectiveIndex() ;
		neff_perturbed = stripTE_perturbed.getEffectiveIndex() ;
		Dneff = neff_perturbed - neff_original ;
		ng_original = stripTE_original.getGroupIndex() ;
