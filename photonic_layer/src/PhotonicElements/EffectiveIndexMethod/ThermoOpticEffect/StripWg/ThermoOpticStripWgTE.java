...
public class ThermoOpticStripWgTE {
	...
	public ThermoOpticStripWgTE(
		...
		ModeStripWgTE stripTE_original = new ModeStripWgTE(stripWg_original, 0, 0) ;
		ModeStripWgTE stripTE_perturbed = new ModeStripWgTE(stripWg_perturbed, 0, 0) ;
	...
	public double getNg(){
        ...
        ModeStripWgTE modeSolver = new ModeStripWgTE(stripWg, 0, 0) ;
