package PhotonicElements.EffectiveIndexMethod.ModeProfile.CoupledSlabWg;
...
public class ProfileCoupledSlabWgTM {
	...
	ModeCoupledSlabWgTM_fast modeTM ;
...
*/
	public ProfileCoupledSlabWgTM(
		...
		modeTM = new ModeCoupledSlabWgTM_fast(inputLambda, coupledSlab) ;
		if(isEvenMode){
