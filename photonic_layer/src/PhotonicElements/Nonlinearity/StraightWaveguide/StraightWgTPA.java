...
public class StraightWgTPA {
	
	Wavelength inputLambda ;
	WgProperties wgProp ;
	double  betaTPA, lengthMicron, pin_mW, lambdaNm, k0, Nc,v0,nTPA;
	...
	public StraightWgTPA(
			...
			@ParamName(name="Carrier lifetime (s)", default_="10e-9") double tau
			){
	this.tau = tau;
