...
public class Si_offset_30um extends AbstractElement {
	...
	double H_um = 50, V_um = 30 , width_um = 0.4 ;
	boolean isUpward ;
	Sbend bend ;
	
	public Si_offset_30um(
	...
	public String[] getPythonCode(String fileName, String topCellName) {
		String st0 = "## ---------------------------------------- ##" ;
		String st1 = "##     Adding a Si OFFSET-30um from AIM     ##" ;
		String st2 = "## ---------------------------------------- ##" ;
	...
	public AbstractElement translateXY(double dX, double dY) {
		...
		AbstractElement si_offset_30um_translated = new Si_offset_100um(objectName, port_translated, isUpward) ;
		return si_offset_30um_translated;
	}
