...
public class SiN_bend_180deg extends AbstractElement {

	/**
	 * 180 degree bend: radius = 100 um (from center to the middle of waveguide) and width = 1 um
	 */
	...
	CurvedWg bend_180deg ;
	boolean toRight ;
	
	public SiN_bend_180deg(
	...
	public void createObject(){
		bend_180deg = new CurvedWg(objectName, layerMap, "port1", port1, toRight, new Entry(radius_um), new Entry(angleDegree)) ;
		port2 = bend_180deg.port2 ;
	}
	...
	public String[] getPythonCode(String fileName, String topCellName) {
		String st0 = "## ---------------------------------------- ##" ;
		String st1 = "##    Adding a SiN 180deg-BEND from AIM     ##" ;
		String st2 = "## ---------------------------------------- ##" ;
		String[] args1 = {st0, st1, st2} ;
		String[] args = bend_180deg.getPythonCode_no_header(fileName, topCellName) ;
	...
	public AbstractElement translateXY(double dX, double dY) {
		AbstractElement bend_180deg_translated = bend_180deg.translateXY(dX, dY) ;
		return bend_180deg_translated ;
	}
