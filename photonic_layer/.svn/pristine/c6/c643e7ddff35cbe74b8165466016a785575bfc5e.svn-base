...
public class TransferMatrixTMSim implements Experiment {

	TransferMatrixTM Qmatrix ;
	Wavelength inputLambda ;
	double angleOfIncidenceDegree ;
	
	public TransferMatrixTMSim(
		...
		Qmatrix = new TransferMatrixTM(inputLambda, nFirst, nSecond, thetaFirstDegree, Xnm) ;
	}
