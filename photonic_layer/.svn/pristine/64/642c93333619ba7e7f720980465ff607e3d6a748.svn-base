...
public class SiN_bend_90deg extends AbstractElement {

	/**
	 * 90 degree bend: radius = 100 um (from center to the middle of waveguide) and width = 1 um
	 */
	...
	public String[] getPythonCode(String fileName, String topCellName) {
		String st0 = "## ---------------------------------------- ##" ;
		String st1 = "##     Adding a SiN 90deg-BEND from AIM     ##" ;
		String st2 = "## ---------------------------------------- ##" ;
	...
	public AbstractElement translateXY(double dX, double dY) {
		AbstractElement bend_90deg_translated = bend_180deg.translateXY(dX, dY) ;
