package People.Meisam.GUI.PhoenixSim.TabsLibrary.HPE_rings.AsymRingWg;
...
import hpe.edu.lrl.ring.neff.NeffCoupled450to450;
...
public class HPERingsAsymTabController extends AbstractTabController {
    ...
    private double getKappaRingWg(double lambda_nm, double radius_um, double d_nm, double width_nm){
    	NeffCoupled450to450 neffModel = new NeffCoupled450to450() ;
    	double[] gap_nm_fromCoupledTab = neffModel.gap_nm ;
    	double[] neff_even_fromCoupledTab = neffModel.neff_TE_even ;
    	double[] neff_odd_fromCoupledTab = neffModel.neff_TE_odd ;
    ...
    private void plotRingWg(){
    	simDataBase.addNewVariable(new SimulationVariable("width_(nm)", "Width (nm)", new double[]{450}));
    	simDataBase.addNewVariable(new SimulationVariable("lambda_(nm)", "Wavelength (nm)", new double[]{1310}));
