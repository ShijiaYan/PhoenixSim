...
public class Si_bend_45deg extends AbstractElement {

	/**
	 * 45 degree bend: radius = 4.8 um (from center to the middle of waveguide) and width = 0.4 um
	 */
