...
public class Si_offset_200um extends AbstractElement {
	...
	Port port ;
	double H_um = 200, V_um = 200 , width_um = 0.4 ;
	boolean isUpward ;
	Sbend bend ;
	
	public Si_offset_200um(
	...
	public String[] getPythonCode(String fileName, String topCellName) {
		String st0 = "## ---------------------------------------- ##" ;
		String st1 = "##    Adding a Si OFFSET-200um from AIM     ##" ;
		String st2 = "## ---------------------------------------- ##" ;
	...
	public AbstractElement translateXY(double dX, double dY) {
		...
		AbstractElement si_offset_200um_translated = new Si_offset_100um(objectName, port_translated, isUpward) ;
		return si_offset_200um_translated;
	}
