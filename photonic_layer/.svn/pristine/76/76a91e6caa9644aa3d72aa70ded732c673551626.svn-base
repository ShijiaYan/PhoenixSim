package PhotonicElements.Utilities.Functions.Convolution;
...
public class Convolution {
	...
	public Convolution(
			@ParamName(name="Convolution Pair") ConvolutionFunctionPair funcs,
			@ParamName(name="Time Period (sec)") double tPeriod,
			@ParamName(name="Time Resolution (sec)") double ts
			){
		this.funcs = funcs ;
		this.ts = ts ;
