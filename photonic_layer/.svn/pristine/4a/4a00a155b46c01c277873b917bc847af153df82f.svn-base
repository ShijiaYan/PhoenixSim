...
public class Si_offset_10um extends AbstractElement {
	...
	double H_um = 50, V_um = 10 , width_um = 0.4 ;
	boolean isUpward ;
	Sbend bend ;
	
	public Si_offset_10um(
	...
	public String[] getPythonCode(String fileName, String topCellName) {
		String st0 = "## ---------------------------------------- ##" ;
		String st1 = "##     Adding a Si OFFSET-10um from AIM     ##" ;
		String st2 = "## ---------------------------------------- ##" ;
	...
	public AbstractElement translateXY(double dX, double dY) {
		...
		AbstractElement si_offset_10um_translated = new Si_offset_100um(objectName, port_translated, isUpward) ;
		return si_offset_10um_translated;
	}
