...
public class AddDropFirstOrder {
	...
	public AddDropFirstOrder (
			...
			WgProperties wgProp,
			double radiusMicron,
			double anglePositionOfDropPortDegree,
			double inputKappa,
			double outputKappa,
			boolean includesHeater,
			SimpleHeater H
			){
		...
		this.Cwg1 = new CurvedWg(inputLambda, wgProp, radiusMicron, anglePositionOfDropPortDegree, false, null, false, null) ;
		this.Cwg2 = new CurvedWg(inputLambda, wgProp, radiusMicron, 360-anglePositionOfDropPortDegree, false, null, includesHeater, H) ;
