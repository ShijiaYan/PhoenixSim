...
public class Omega4x4MZISwitch implements Experiment {
...
//		Complex one = new Complex(1,0) ;
		...
		dp.addProperty("State of all switches", state[0]+state[1]+state[2]+state[3]);
		dp.addProperty("State of Sources", sourceState);
		dp.addProperty("Crossing IL (dB)", -10*Math.log10(wgCrossing.getS31().absSquared()));
		
		dp.addResultProperty("Port 1 Out (dBm)", checkNaN(10*Math.log10(port13.absSquared())) );
		dp.addResultProperty("Port 2 Out (dBm)", checkNaN(10*Math.log10(port23.absSquared())) );
		dp.addResultProperty("Port 3 Out (dBm)", checkNaN(10*Math.log10(port33.absSquared())) );
		dp.addResultProperty("Port 4 Out (dBm)", checkNaN(10*Math.log10(port43.absSquared())) );
		dp.addResultProperty("State of all switches", state[0]+state[1]+state[2]+state[3]);
		dp.addResultProperty("State of Sources", sourceState);
