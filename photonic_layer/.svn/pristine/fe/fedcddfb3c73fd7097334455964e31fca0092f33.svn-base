...
public class CustomChartPanel extends ChartPanel {
	 private static final long serialVersionUID = 1L;
	   ...
	   private int cwidth;
	   private int cheight;
	   public CustomChartPanel(JFreeChart chart, int width, int height, int minimumDrawWidth, int minimumDrawHeight, int maximumDrawWidth, int maximumDrawHeight, boolean useBuffer, boolean properties, boolean save, boolean print, boolean zoom, boolean tooltips){
