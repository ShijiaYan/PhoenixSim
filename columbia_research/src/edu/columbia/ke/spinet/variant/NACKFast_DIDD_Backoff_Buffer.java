...
public class NACKFast_DIDD_Backoff_Buffer extends NACKFast_Backoff_Buffer {

	private boolean frozen;
	
	public NACKFast_DIDD_Backoff_Buffer(int maxSize, double bufferLatency,
	...
	protected void resetWaitTime() {
		...
		this.waitTimeUpper = this.waitTimeUpper/this.waitTimeExpBase;
