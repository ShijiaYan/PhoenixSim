...
public class XtalkAwareTransceiverModel extends AbstractTransceiverModel {
	...
	public XtalkAwareTransceiverModel(AbstractReceiverSensitivityModel detectorModel,
			AbstractRingBased_OOK_NRZ_ModulatorArrayModel modArray,
			AbstractDemux demux,
			Constants ct,
	...
	@Override
	public double getNonLaserPowerConsumption(double rate, int numberOfWavelengths,
			double linkBudgetIndB) {
