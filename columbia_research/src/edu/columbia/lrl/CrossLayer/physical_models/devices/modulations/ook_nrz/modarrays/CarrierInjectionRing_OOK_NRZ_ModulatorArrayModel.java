...
public class CarrierInjectionRing_OOK_NRZ_ModulatorArrayModel extends AbstractRingBased_OOK_NRZ_ModulatorArrayModel {
    ...
    public CarrierInjectionRing_OOK_NRZ_ModulatorArrayModel(Abstract_OOK_NRZ_Receiver ookReceiver,
                                                            @ParamName(name = "Modulator ring model", defaultClass_ =
																	DefaultInjectionModulatorRing.class) AbstractRingModel absRing,
                                                            @ParamName(name = "Power model", defaultClass_ =
																	RateDependentRingPNJunctionDepletionDriverPowerModel.class) AbstractRingPNJunctionDriverPowerModel powerModel,
                                                            @ParamName(name = "Desired shift(relative to half " +
																	"spacing, -1 for max)", default_ = "-1") double resShift,
    ...
    public ArrayList<PowerPenalty> getPassbyModulationBankPowerPenalties(PhysicalParameterAndModelsSet modelSet,
        ...
        return MoreArrays
                .getArrayList(this.getInsertionLossPowerPenalties(modelSet, linkFormat, false));
    }
    ...
    public static class DefaultInjectionModulatorRing extends QandERRingModel {

        public DefaultInjectionModulatorRing(@ParamName(name = "Modulator Q", default_ = "12000") double q,
