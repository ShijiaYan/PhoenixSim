...
//		double powerPulseCarver = 0.5 * capPulseCarver *vPulseCarver*vPulseCarver * dataRate*dataRate /
//		bandwidthModulator ; // pulse carver is independent of modulation format
