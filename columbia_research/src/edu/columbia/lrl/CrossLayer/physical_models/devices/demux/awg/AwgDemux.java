...
public class AwgDemux extends AbstractDemux {
    ...
    public Map<String, String> getAllParameters() {
        ...
        map.put("Passive insertion loss (dB)", this.passiveIL + "");
        map.put("Polarization Loss (dB)", this.polarizationLoss + "");
        map.put("AWG Demux FSR", this.demuxFSR + "");
        map.put("Number of Branches", this.numBranch + "");
        map.put("AWG Thermal Tuning Power", this.awgStaticPower + "");
    ...
    public ArrayList<PowerPenalty> getPowerPenalties(PhysicalParameterAndModelsSet modelSet,
        ...
        PowerPenalty il = new PowerPenalty(PowerPenalty.INSERTION_LOSS, "Demux", insertionLoss[bestIndex]);
    ...
    public double getAwgTransmission(double freq, double centerFreq, double Q_demux) {
        ...
        double arg = Math.sin(Math.PI * 2 * (freq - centerFreq) / bandwidth)
                / (Math.PI * 2 * (freq - centerFreq) / bandwidth);
