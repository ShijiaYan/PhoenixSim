...
public class OOK_NRZ_Receiver_RobertPolster extends Abstract_OOK_NRZ_Receiver {
    ...
    private static final String fileName28 = "data/DataS28PrecVsBRVsIin.csv";
    private static final String fileName65 = "data/DataS65PrecVsBRVsIin.csv";
    ...
    public OOK_NRZ_Receiver_RobertPolster(@ParamName(name = "Node Technology") OOK_NRZ_Receiver_RobertPolster.Techno t,
    ...
    public double getReceiverSensitivity(PhysicalParameterAndModelsSet modeSet, AbstractLinkFormat format) {
        ...
        for (Entry<Float, TreeMap<Float, Float>> floatTreeMapEntry : db.entrySet()) {
        ...
        try {
            ...
            while (true) {
                ...
                if (man != null) {
                    ...
                    if (Double.isNaN(pJperBitT)) System.out.println(".");
    ...
    public double getPowerConsumptionMW(double bitrate, double iCurrent) {
        ...
        if (bottomCurrent == null) {
            ...
            Entry<Float, Float> bottomCurrentBottomBitrate = bottomCurrent.getValue()
                    .floorEntry((float) bitrate);
            Entry<Float, Float> bottomCurrentTopBitrate = bottomCurrent.getValue()
                    .higherEntry((float) bitrate);
            Entry<Float, Float> topCurrentBottomBitrate = topCurrent.getValue().floorEntry((float) bitrate);
            Entry<Float, Float> topCurrentTopBitrate = topCurrent.getValue().higherEntry((float) bitrate);
            ...
            if (bottomCurrentTopBitrate == null) {
                throw new WrongExperimentException("Bit rate exceeds receiver capability");
            } else {
    ...
    public static void test1() {
        ...
        for (Techno t : Techno.values()) {
            ...
            OOK_NRZ_Receiver_RobertPolster rec = new OOK_NRZ_Receiver_RobertPolster(t, 1, 0.5,
