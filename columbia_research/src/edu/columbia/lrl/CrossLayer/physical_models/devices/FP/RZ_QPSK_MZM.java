...
public class RZ_QPSK_MZM extends AbstractMZM  {
	// Parameters
...
//		this.vPeakToPeak = vPeakToPeak;
	...
	public double getModulatorPowerConsumption(){
		...
		double effdataRate = 0.5 * dataRate ; // This is symbol rate for each of I and Q modulators
		...
		double dynPower = powerPulseCarver + 2* powerModulator ;
		
		double totPower = powerPulseCarver + 2*powerModulator + 2 * statPower * 1e6 ; // micro watts -- We have two modulators (I , Q)
