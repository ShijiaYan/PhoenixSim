...
public class Slotted_NACKFast_Quenchable_Buffer extends NACKFast_SlottedBuffer {
	
	private boolean quenchEnabled;
	private double packetTransTime;

	public Slotted_NACKFast_Quenchable_Buffer(int maxSize, double bufferLatency,
			double spinetSwitchingTimeNS, double slotDuration, boolean quenchEnabled, int index) {
