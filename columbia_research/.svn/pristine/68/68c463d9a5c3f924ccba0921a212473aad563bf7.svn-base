...
public abstract class AbstractModulator {
	...
	public abstract ArrayList<PowerConsumption> getPowerConsumption(PhysicalParameterAndModelsSet modelSet, AbstractLinkFormat linkFormat);

	public abstract boolean modulatorHasThroughCapability();

	public abstract ArrayList<PowerPenalty> getPassbyPowerPenalties(PhysicalParameterAndModelsSet modelSet, AbstractLinkFormat linkFormat);
