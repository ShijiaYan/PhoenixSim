...
public abstract class AbstractDemodulatorAndReceiver {
	...
	public abstract ArrayList<PowerPenalty> getDemodulationPowerPenalties(
	...
	public abstract double getReceiverSensitivity(PhysicalParameterAndModelsSet modeSet,
			AbstractLinkFormat format);	
	
	public abstract Map<String, String> getAllReceiverParameters();		
	
	public ArrayList<PowerPenalty> getJitterPowerPenalty(PhysicalParameterAndModelsSet modelSet, AbstractLinkFormat linkFormat) {
		PowerPenalty jitter = new PowerPenalty(PowerPenalty.JITTER, AbstractDemodulatorAndReceiver.RECEIVER, this.passiveJitterPenalty);
