...
public class PointToPointMaxAggregation implements Experiment {
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++	 
	 ...
	 public PointToPointMaxAggregation(
...
//		 double demodEnergyPerBit = demodPowerConsumption / modulatorModel.getModulationRateGbps() ;
		 ...
		 double diffBudget = linkBudgetdB - totPP ;
		 ...
		 LinkEnergyPerBit = totLinkPowerConsumption/(numChannels * modulatorModel.getModulationRateGbps()) ; // Note: total aggregate rate 
...
/*		dp.addResultProperty("Receiver Sensitivity (dBm)", sensitivity );
		...
		dp.addResultProperty("Max Aggregation (Tb/s)", numChannels * modulatorModel.getModulationRateGbps()/1e3);
		dp.addResultProperty("Energy (pJ/bit)", LinkEnergyPerBit/1e3);
