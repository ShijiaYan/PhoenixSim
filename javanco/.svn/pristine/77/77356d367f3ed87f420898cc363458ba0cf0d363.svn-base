...
import ch.epfl.javanco.path.AttributeBasedCalculator;
import ch.epfl.javanco.path.CombinationBasedShortestDistancePathSet;
...
public class ShortestDistancePathSetTest {
	...
	public static void main(String[] args) throws Exception {
		ShortestDistancePathSetTest test = new ShortestDistancePathSetTest();
		test.testEnum();
	//	test.testElim();
	}
	...
	public void testEnum() throws Exception {
		...
		AbstractTopologyGenerator.createPolygonNodes(agh, 20, 200, 0, 0);
