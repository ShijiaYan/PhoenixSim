...
public abstract class AbstractParameterChooseNode extends AbstractChooseNode {
    ...
    protected abstract AbstractParameterChooseNode paremeterChooseNodeClone(Class<?> userObject,
                                                                            Map<String, String> annotationMap2,
                                                                            ObjectConstructionTreeModel<?> containingTreeModel, boolean b)
            throws Exception;

    public AbstractParameterChooseNode(Class<?> c, ObjectConstructionTreeModel<?> containingTree,
    ...
    public DefinitionIterator getObjectDefinitionIterator() {
        return new DefinitionIterator() {
            ...
            Iterator<AbstractChooseNode> childConstructors;
            ...
            void reset() {
                ...
                childConstructors = children.iterator();
            ...
            private boolean startWithNextConstructor() {
                AbstractChooseNode abstractNode = childConstructors.next();
                ...
                boolean b = !childConstructors.hasNext();
                return b;
            }
            ...
            private ObjectDefinition getNext() {
                ...
                if (currentConstructor != null) {
                    futureNext = new ObjectDefinition(((Class<?>) getUserObject()).getCanonicalName(),
                            ((Constructor<?>) currentConstructor.getUserObject()).getDeclaringClass().getName());
                } else {
                    futureNext = new ObjectDefinition(((Class<?>) getUserObject()).getCanonicalName());
                }
        ...
        Iterator<Pair<Object, ObjectRecipe>> ret = new Iterator<Pair<Object, ObjectRecipe>>() {
            ...
            public Pair<Object, ObjectRecipe> next() {
                if (hasChildrenNext()) {
                    ...
                    if (AbstractParameterChooseNode.this instanceof ArrayChooseNode
                            && currentIteratorChild instanceof ConstructorChooseNode) {
    ...
    public Object clone() {
        try {
            AbstractParameterChooseNode ret = paremeterChooseNodeClone((Class<?>) this.getUserObject(), annotationMap,
                    this.getContainingTreeModel(), false);
                ...
                for (Object c : this.children) {
                    ...
                    if (!(node instanceof ConstructorNodeChooserPointer)) {
                        ...
                        if (AbstractChooseNode.map.containsKey(p)) {
                            ...
                            toAdd = new ConstructorNodeChooserPointer(this.getContainingTreeModel(),
                                    p.getSuperInstance());
                        }
