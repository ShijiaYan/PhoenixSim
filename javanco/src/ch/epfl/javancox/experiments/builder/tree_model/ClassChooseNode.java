...
public class ClassChooseNode extends AbstractParameterChooseNode implements Serializable {
    ...
    protected ClassChooseNode(Class<?> c, Map<String, String> annotationMap,
                              ObjectConstructionTreeModel<?> containingTree, boolean checkDef) throws Exception {
        ...
        if (parameterType.equals("java.lang.Class")) {
            ...
            if (subClasses.size() > 1) {
                ...
                ErrorChooseNode error = new ErrorChooseNode("Cannot find any corresponding class",
    ...
    private List<Class<?>> getHeritedClassesImplementingRequiredInterface() throws ClassNotFoundException, Exception {
        ...
        if (annotationMap.get("ParamName.requireInterface") != null) {
            ...
            subClasses.removeIf(candidate -> !extraInterface.isAssignableFrom(candidate/* Integer.class */));
        }
        return subClasses;
    }
    ...
    private boolean checkNoParamMethod(Class<?> c) throws Exception {
        try {
            ...
            ConstructorChooseNode newNode = new ConstructorChooseNode(empty, Class.forName(parameterType),
                    getContainingTreeModel(), null, true);
            newNode.setExpanded(false);
            this.add(newNode);
            return true;
    ...
    private boolean checkWithDefaultParam(Class<?> c, String def) throws Exception {
        ...
        if (cons != null && defVal != null) {
            ConstructorChooseNode newNode = new ConstructorChooseNode(cons, c, this.getContainingTreeModel(), defVal,
                    true);
            newNode.setExpanded(false);
            this.add(newNode);
            return true;
    ...
    private boolean checkAllDefaultParams(Class<?> c) throws Exception {
        ...
        int i = 0;
        while (defaultConstructor == null && i < constrArray.length) {
        ...
        if (defaultConstructor != null) {
            ConstructorChooseNode newCN = new ConstructorChooseNode(defaultConstructor, c, getContainingTreeModel(),
                    null, true);
            this.add(newCN);
    ...
    public void actionPerformed(String key) {
        ...
        try {
            ...
            if (parameterType.equals("java.lang.Class")) {
                ...
                newNode = new ConstructorChooseNode(cons, Class.forName(parameterType), this.getContainingTreeModel(),
                        null, checkDef);
    ...
    private ActionStructure getConstructorStructure(Constructor<?> cons) {
        ...
        ActionStructure newConstructor = new ActionStructure(createConstructorString(cons),
                constructorKey + DEFAULT_SUFFIX);
    ...
    public List<ActionItem> getActions() {
        ...
        try {
            ...
            Map<ConstructorChooseNode, Integer> constructorMap = this.getContainingTreeModel()
                    .getConfiguredConstructors();
            ...
            if (!(parameterType.equals("int") || parameterType.equals("float") || parameterType.equals("long")
                    ...
                    || parameterType.equals("boolean") || parameterType.equals("java.lang.String")
                    || parameterType.equals("java.lang.Class"))) {
    ...
    @Override
    protected AbstractParameterChooseNode paremeterChooseNodeClone(Class<?> userObject,
