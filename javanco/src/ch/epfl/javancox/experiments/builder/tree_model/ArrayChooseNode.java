...
public class ArrayChooseNode extends AbstractParameterChooseNode {
	...
	public ArrayChooseNode(Class<?> c, Map<String, String> annotationMap, ObjectConstructionTreeModel<?> containingTree,
	...
	private void addLeaf(boolean checkDef) throws Exception {
		if (isTypableType()) {
			...
			this.add(new UntypeableArrayInstanceNode(Class.forName(parameterType), containingTreeModel, annotationMap,
					checkDef));
		}
	}
	...
	public List<ActionItem> getActions() {
		...
		ActionItem remove = new ActionItem("Remove all", AbstractParameterChooseNode.REMOVE_ALL);
		toReturn.add(addNew);
	...
	protected AbstractParameterChooseNode paremeterChooseNodeClone(Class<?> userObject,
                                                                   Map<String, String> annotationMap2, ObjectConstructionTreeModel<?> containingTreeModel, boolean b)
			throws Exception {
