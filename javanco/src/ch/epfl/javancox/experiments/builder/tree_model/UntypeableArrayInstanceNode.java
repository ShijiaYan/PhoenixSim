...
public class UntypeableArrayInstanceNode extends ClassChooseNode {


	private static final long serialVersionUID = 1L;
	private Class<?> arrayClass;
	
	public UntypeableArrayInstanceNode(Class<?> c,
	...
	public List<ActionItem> getActions() {
		...
		try {
			...
			if (arrayClass.equals(Class.class)) {
				String classType = annotationMap.get("ParamName.abstractClass");
				buildClassMenu(toReturn, classType);
	...
	protected AbstractParameterChooseNode paremeterChooseNodeClone(
			...
			throws Exception {
		return new UntypeableArrayInstanceNode(userObject, containingTreeModel, annotationMap2, b);
	}	
