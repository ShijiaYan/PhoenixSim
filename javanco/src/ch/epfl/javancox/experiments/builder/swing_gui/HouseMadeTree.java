...
public class HouseMadeTree<X> extends JScrollPane implements TreeModelUIManager, MouseWheelListener {
    ...
    ObjectConstructionTreeModel<X> mod;
    ...
    public HouseMadeTree(ObjectConstructionTreeModel<X> mod) {
        ...
        mainPanel.setName("Javanco Tree Simulation");
    ...
    private AbstractGUIContainer getContainer(AbstractChooseNode node, int prefix) {
        ...
        if (c == null) {
            ...
            if (node instanceof UntypeableArrayInstanceNode) {
...
class LineLayoutManager implements LayoutManager2 {
    ...
    HashMap<Component, Placement> map = new HashMap<>();
        ...
        for (Component comp : parent.getComponents()) {
            ...
            if (p == null) {
                ...
                if (p.left) {
                    ...
                    r = new Rectangle(tree.mainPanel.getWidth() - p.to - prefix * HouseMadeTree.xOffset, 1,
                            p.to - p.from, parent.getHeight() - 3);
                }
            }
            comp.setBounds(r);
...
class Widget extends Container {
    ...
    Widget(int prefix, boolean[] cont, boolean isLast, boolean isExpanded, boolean hasChild,
           final AbstractGUIContainer assos) {
        this.prefix = prefix;
        this.cont = cont;
        this.isLast = isLast;
    ...
    public void paint(Graphics g) {
        ...
        for (int i = 0; i < prefix - 1; i++) {
            ...
            if (cont[i]) g.drawLine(x, 0, x, yOffset);
        }
