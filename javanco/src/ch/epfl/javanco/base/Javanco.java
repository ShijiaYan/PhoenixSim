...
public class Javanco {
	...
	public static final String DEFAULT_PROPERTIES_LOCATION = "../Library/div/javanco.properties.xml";
...
//	public static final String JAVANCO_HOME_PROPERTY = "../Library/";
		...
		/*if (javancoHome == null) {
			...
			if (javancoHome == null) {
				...
				if (javancoHome == null) {
					...
					//3. Last try : use the library option
